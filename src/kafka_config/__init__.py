...
API_SECRET_KEY = "gEmraUyau1u4a8ZsTxaYiBetpLvkRKwHk7RbwSooIOK8qQ4xGFDwziIEXAdGzeio"#os.getenv('API_SECRET_KEY',None)
...
SCHEMA_REGISTRY_API_SECRET = "nnJEYxkwhqjUdAk3m/b0Wu0N7wrKbj5YCPo/5TXzmxH2GEK597g3qimMRcGxQsEB"#os.getenv('SCHEMA_REGISTRY_API_SECRET',None)
